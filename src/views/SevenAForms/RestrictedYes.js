...
export default function RestrictedYes() {
    ...
    <div className={classes.container}>
      <GridContainer justify="center">
        <GridItem xs={12} sm={12} md={6} className={classes.center}>
          <h2>Restricted Business Profile</h2>
          <h5>
            Due to the nature of your business activity, you're not eligible for a SBA 7(a) loan. 
          </h5>
        </GridItem>
      </GridContainer>
      <GridContainer justify="center">
        <GridItem xs={12} sm={12} md={6}>
          <Card pricing raised>
            <CardBody pricing>
              <h6 className={classes.cardCategory}>RESTRICTED ACTIVITY</h6>
